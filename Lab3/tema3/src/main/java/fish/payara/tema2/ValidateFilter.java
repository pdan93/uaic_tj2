...
public class ValidateFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (request.getMethod().equals("POST")) {
            ...
            if (word.length() == 0) {
                isOk = false;
                errorMessage = "word must not be empty. ";
            }
            if (definition.length() == 0) {
                isOk = false;
                errorMessage += "definition must not be empty. ";
            }
            ...
            if (isOk == false) {
                ...
                if (language.length() == 0) {
                    String languageDefault = filterConfig.getServletContext().getInitParameter("languageDefault");
                    String [] languageParam = {languageDefault};
                    request.setParameter("language", languageParam);
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("ValidateFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("ValidateFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("ValidateFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("ValidateFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("ValidateFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
